...
export default class AtmsBodyFiltered extends React.Component {
...
componentDidMount() {
  ...
  render() {
    ...
    //const filteredAtms = atms.slice(0,5)
    ...
    return <Fragment>
          ...
          <Card className="card info-card revenue-card top-selling card-small">
                  ...
                  <Card.Body className="card-body pb-0">
                    ...
                    <Table className="table table-borderless datatable scrollableTable">
