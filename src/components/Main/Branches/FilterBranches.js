        ...
        <div className="filter">
          <Dropdown>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={() => this.handleFilter("Nyitva")}>{this.props.filter2}</Dropdown.Item>
              <Dropdown.Item onClick={() => this.handleFilter("Zárva")}>{this.props.filter3}</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </div>
      </Fragment>
