...
class RecurringTransfersBody extends React.Component {
              ...
              <Card.Body className="card-body pb-0">
                ...
                <Table className="table table-borderless datatable">
                  ...
                  {beneficiaries.map(a =>            
                    ...
                    <TableRowRecurringTransfers key={a.id} col1={a.name} col2={a.partner_name} col3={a.partner_account_number}/>
                    )}
                 </tbody>
                </Table>
              </Card.Body>
...
export default connect(mapStateToProps)(RecurringTransfersBody) 